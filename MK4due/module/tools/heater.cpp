...
//===========================================================================
  ...
  #if NUM_HEATER > 0
    {
      0, TEMP_SENSOR_0, TEMP_0_PIN, HEATER_0_PIN,
      ...
      HEATER_0_AUTO_FAN, HEATER_0_AUTO_FAN_PIN, HEATER_0_AUTO_FAN_TEMPERATURE,
      HEATER_0_AUTO_FAN_MAX_SPEED, HEATER_0_AUTO_FAN_MIN_SPEED,
      0
    }
  #endif
  #if NUM_HEATER > 1
    ,{
      1, TEMP_SENSOR_1, TEMP_1_PIN, HEATER_1_PIN,
      0, 0, HEATER_1_MINTEMP, HEATER_1_MAXTEMP, 0, 0,   // Temperature
      HEATER_1_PIDTEMP, 0, 0, 0, 100, HEATER_1_PID_MAX, // PID
      {0}, TEMP_SENSOR_AD595_OFFSET, TEMP_SENSOR_AD595_GAIN,
      HEATER_1_AUTO_FAN, HEATER_1_AUTO_FAN_PIN, HEATER_1_AUTO_FAN_TEMPERATURE,
      HEATER_1_AUTO_FAN_MAX_SPEED, HEATER_1_AUTO_FAN_MIN_SPEED,
      0
    }
  #endif
  #if NUM_HEATER > 2
    ,{
      2, TEMP_SENSOR_2, TEMP_2_PIN, HEATER_2_PIN,
      0, 0, HEATER_2_MINTEMP, HEATER_2_MAXTEMP, 0, 0,   // Temperature
      HEATER_2_PIDTEMP, 0, 0, 0, 100, HEATER_2_PID_MAX, // PID
      {0}, TEMP_SENSOR_AD595_OFFSET, TEMP_SENSOR_AD595_GAIN,
      HEATER_2_AUTO_FAN, HEATER_2_AUTO_FAN_PIN, HEATER_2_AUTO_FAN_TEMPERATURE,
      HEATER_2_AUTO_FAN_MAX_SPEED, HEATER_2_AUTO_FAN_MIN_SPEED,
      0
    }
  #endif
  #if NUM_HEATER > 3
    ,{
      3, TEMP_SENSOR_3, TEMP_3_PIN, HEATER_3_PIN,
      0, 0, HEATER_3_MINTEMP, HEATER_3_MAXTEMP, 0, 0,   // Temperature
      HEATER_3_PIDTEMP, 0, 0, 0, 100, HEATER_3_PID_MAX, // PID
      {0}, TEMP_SENSOR_AD595_OFFSET, TEMP_SENSOR_AD595_GAIN,
      HEATER_3_AUTO_FAN, HEATER_3_AUTO_FAN_PIN, HEATER_3_AUTO_FAN_TEMPERATURE,
      HEATER_3_AUTO_FAN_MAX_SPEED, HEATER_3_AUTO_FAN_MIN_SPEED,
      0
    }
  #endif
  #if NUM_HEATER > 4
    ,{
      4, TEMP_SENSOR_4, TEMP_4_PIN, HEATER_4_PIN,
      0, 0, HEATER_4_MINTEMP, HEATER_4_MAXTEMP, 0, 0,   // Temperature
      HEATER_4_PIDTEMP, 0, 0, 0, 100, HEATER_4_PID_MAX, // PID
      {0}, TEMP_SENSOR_AD595_OFFSET, TEMP_SENSOR_AD595_GAIN,
      HEATER_4_AUTO_FAN, HEATER_4_AUTO_FAN_PIN, HEATER_4_AUTO_FAN_TEMPERATURE,
      HEATER_4_AUTO_FAN_MAX_SPEED, HEATER_4_AUTO_FAN_MIN_SPEED,
      0
    }
  #endif
  #if NUM_HEATER > 5
    ,{
      5, TEMP_SENSOR_5, TEMP_5_PIN, HEATER_5_PIN,
      0, 0, HEATER_5_MINTEMP, HEATER_5_MAXTEMP, 0, 0,   // Temperature
      HEATER_5_PIDTEMP, 0, 0, 0, 100, HEATER_5_PID_MAX, // PID
      {0}, TEMP_SENSOR_AD595_OFFSET, TEMP_SENSOR_AD595_GAIN,
      HEATER_5_AUTO_FAN, HEATER_5_AUTO_FAN_PIN, HEATER_5_AUTO_FAN_TEMPERATURE,
      HEATER_5_AUTO_FAN_MAX_SPEED, HEATER_5_AUTO_FAN_MIN_SPEED,
      0
    }
  #endif
  };
