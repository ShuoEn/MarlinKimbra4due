...
#define HAS_TEMP_6      (PIN_EXISTS(TEMP_6) && TEMP_SENSOR_6 != 0)
...
#define HAS_AUTO_FAN_0  (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HEATER_0_AUTO_FAN))
#define HAS_AUTO_FAN_1  (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HEATER_1_AUTO_FAN))
#define HAS_AUTO_FAN_2  (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HEATER_2_AUTO_FAN))
#define HAS_AUTO_FAN_3  (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HEATER_3_AUTO_FAN))
#define HAS_AUTO_FAN_4  (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HEATER_4_AUTO_FAN))
#define HAS_AUTO_FAN_5  (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HEATER_5_AUTO_FAN))
#define HAS_AUTO_FAN_6  (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HEATER_6_AUTO_FAN))
