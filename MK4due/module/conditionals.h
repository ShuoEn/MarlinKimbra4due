 ...
 */
#if TEMP_SENSOR_0 == -2
  #define HOTEND_0_USES_MAX6675
#elif TEMP_SENSOR_0 == -1
  #define HOTEND_0_USES_AD595
#elif TEMP_SENSOR_0 == 0
  #undef HOTEND_0_MINTEMP
  #undef HOTEND_0_MAXTEMP
#elif TEMP_SENSOR_0 > 0
  #define THERMISTORHOTEND_0 TEMP_SENSOR_0
  #define HOTEND_0_USES_THERMISTOR
#endif

#if TEMP_SENSOR_1 == -1
  #define HOTEND_1_USES_AD595
#elif TEMP_SENSOR_1 == 0
  #undef HOTEND_1_MINTEMP
  #undef HOTEND_1_MAXTEMP
#elif TEMP_SENSOR_1 > 0
  #define THERMISTORHOTEND_1 TEMP_SENSOR_1
  #define HOTEND_1_USES_THERMISTOR
#endif

#if TEMP_SENSOR_2 == -1
  #define HOTEND_2_USES_AD595
#elif TEMP_SENSOR_2 == 0
  #undef HOTEND_2_MINTEMP
  #undef HOTEND_2_MAXTEMP
#elif TEMP_SENSOR_2 > 0
  #define THERMISTORHOTEND_2 TEMP_SENSOR_2
  #define HOTEND_2_USES_THERMISTOR
#endif

#if TEMP_SENSOR_3 == -1
  #define HOTEND_3_USES_AD595
#elif TEMP_SENSOR_3 == 0
  #undef HOTEND_3_MINTEMP
  #undef HOTEND_3_MAXTEMP
#elif TEMP_SENSOR_3 > 0
  #define THERMISTORHOTEND_3 TEMP_SENSOR_3
  #define HOTEND_3_USES_THERMISTOR
#endif
...
#define HEATER_USES_AD595 (ENABLED(HOTEND_0_USES_AD595) || ENABLED(HOTEND_1_USES_AD595) || ENABLED(HOTEND_2_USES_AD595) || ENABLED(HOTEND_3_USES_AD595))
 ...
 */
#if BEDS > 3
  #define ARRAY_BY_BEDS(v1, v2, v3, v4) { v1, v2, v3, v4 }
#elif BEDS > 2
  #define ARRAY_BY_BEDS(v1, v2, v3, v4) { v1, v2, v3 }
#elif BEDS > 1
  #define ARRAY_BY_BEDS(v1, v2, v3, v4) { v1, v2 }
#elif BEDS > 0
  #define ARRAY_BY_BEDS(v1, v2, v3, v4) { v1 }
#else
  #define ARRAY_BY_BEDS(v1, v2, v3, v4) {}
#endif

#define ARRAY_BY_BEDS1(v1) ARRAY_BY_BEDS(v1, v1, v1, v1)
...
#define HAS_TEMP_BED_0 (PIN_EXISTS(TEMP_BED_0) && TEMP_SENSOR_BED_0 != 0)
#define HAS_TEMP_BED_1 (PIN_EXISTS(TEMP_BED_1) && TEMP_SENSOR_BED_1 != 0)
#define HAS_TEMP_BED_2 (PIN_EXISTS(TEMP_BED_2) && TEMP_SENSOR_BED_2 != 0)
#define HAS_TEMP_BED_3 (PIN_EXISTS(TEMP_BED_3) && TEMP_SENSOR_BED_3 != 0)
#define HAS_HOTEND_0 (PIN_EXISTS(HOTEND_0))
#define HAS_HOTEND_1 (PIN_EXISTS(HOTEND_1))
#define HAS_HOTEND_2 (PIN_EXISTS(HOTEND_2))
#define HAS_HOTEND_3 (PIN_EXISTS(HOTEND_3))
#define HAS_BED_0 (PIN_EXISTS(BED_0))
#define HAS_BED_1 (PIN_EXISTS(BED_1))
#define HAS_BED_2 (PIN_EXISTS(BED_2))
#define HAS_BED_3 (PIN_EXISTS(BED_3))
#define HAS_AUTO_FAN_0 (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HOTEND_0_AUTO_FAN))
#define HAS_AUTO_FAN_1 (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HOTEND_1_AUTO_FAN))
#define HAS_AUTO_FAN_2 (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HOTEND_2_AUTO_FAN))
#define HAS_AUTO_FAN_3 (ENABLED(HEATER_AUTO_FAN) && PIN_EXISTS(HOTEND_3_AUTO_FAN))
 ...
 */
  ...
  #define WRITE_HEATER(pin, value) WRITE_VAR(pin, !value)
#else
  #define WRITE_HEATER(pin, value) WRITE_VAR(pin, value)
#endif
#if HAS(FAN)
  #if ENABLED(INVERTED_HEATER_PINS)
    #define WRITE_FAN(v) WRITE_VAR(FAN_PIN, !v)
  #else
    #define WRITE_FAN(v) WRITE_VAR(FAN_PIN, v)
  #endif
#endif
