...
/*
  ...
  #undef HEATER_HOTENDS
  #define HEATER_HOTENDS EXTRUDERS
#endif
*/
 ...
 * HEATER
 */
#define NUM_HEATER  (HEATER_HOTENDS + HEATER_BEDS + HEATER_CHAMBERS)
#define MIN_BED     HEATER_HOTENDS
#define MAX_BED     MIN_BED + HEATER_BEDS - 1
#define MIN_CHAMBER HEATER_HOTENDS + HEATER_BEDS
#define MAX_CHAMBER MIN_CHAMBER + HEATER_CHAMBERS - 1
 ...
 * Temp Sensor defines
 */
#if TEMP_SENSOR_0 == 101
  #define HEATER_0_USES_MAX6675
#elif TEMP_SENSOR_0 == 100
  #define HEATER_0_USES_AD595
#endif
#if TEMP_SENSOR_1 == 100
...
#define HEATER_USES_AD595 (ENABLED(HEATER_0_USES_AD595) || ENABLED(HEATER_1_USES_AD595) || ENABLED(HEATER_2_USES_AD595) || ENABLED(HEATER_3_USES_AD595) || ENABLED(HEATER_4_USES_AD595) || ENABLED(HEATER_5_USES_AD595))
 ...
 */
#define HAS_PIDTEMP     (HEATER_0_PIDTEMP || HEATER_2_PIDTEMP || HEATER_3_PIDTEMP || HEATER_4_PIDTEMP || HEATER_5_PIDTEMP)
#define HAS_TEMP        (NUM_HEATER > 0)
#define HAS_TEMP_0      (PIN_EXISTS(TEMP_0) && TEMP_SENSOR_0 != 0)
#define HAS_TEMP_1      (PIN_EXISTS(TEMP_1) && TEMP_SENSOR_1 != 0)
#define HAS_TEMP_2      (PIN_EXISTS(TEMP_2) && TEMP_SENSOR_2 != 0)
#define HAS_TEMP_3      (PIN_EXISTS(TEMP_3) && TEMP_SENSOR_3 != 0)
#define HAS_TEMP_4      (PIN_EXISTS(TEMP_4) && TEMP_SENSOR_4 != 0)
#define HAS_TEMP_5      (PIN_EXISTS(TEMP_5) && TEMP_SENSOR_5 != 0)
...
#define HAS_AUTO_FAN_0  (HEATER_0_AUTO_FAN && PIN_EXISTS(HEATER_0_AUTO_FAN))
#define HAS_AUTO_FAN_1  (HEATER_1_AUTO_FAN && PIN_EXISTS(HEATER_1_AUTO_FAN))
#define HAS_AUTO_FAN_2  (HEATER_2_AUTO_FAN && PIN_EXISTS(HEATER_2_AUTO_FAN))
#define HAS_AUTO_FAN_3  (HEATER_3_AUTO_FAN && PIN_EXISTS(HEATER_3_AUTO_FAN))
#define HAS_AUTO_FAN_4  (HEATER_4_AUTO_FAN && PIN_EXISTS(HEATER_4_AUTO_FAN))
#define HAS_AUTO_FAN_5  (HEATER_5_AUTO_FAN && PIN_EXISTS(HEATER_5_AUTO_FAN))
#define HAS_AUTO_FAN    (HAS_AUTO_FAN_0 || HAS_AUTO_FAN_1 || HAS_AUTO_FAN_2 || HAS_AUTO_FAN_3 || HAS_AUTO_FAN_4 || HAS_AUTO_FAN_5)
